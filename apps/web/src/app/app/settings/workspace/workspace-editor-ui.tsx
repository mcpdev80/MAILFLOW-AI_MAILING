  ...
  return (
    <div className={styles.presets}>
      ...
      <div className={styles.presetRow}>
        {presets.map((preset) => (
          <button
            ...
            aria-pressed={controller.activeLayout === preset}
            onClick={() => void controller.applyPreset(preset)}
            style={
              controller.activeLayout === preset
                ? {
      ...
      <div className="muted" style={{ marginTop: 8, fontSize: 12 }}>
        Choose one of the five Figma desktop layouts, or edit the custom panel
        arrangement below.
      </div>
    </div>
  );
