...
export const esModelSettings: Partial<Record<TranslationKey, string>> = {
  ...
  "models.description": "La clasificación rápida gestiona las primeras etapas, la clasificación profunda los casos ambiguos y el modelo de generación las tareas de escritura. Los endpoints por rol son opcionales y usan los valores predeterminados del proveedor como fallback.",
