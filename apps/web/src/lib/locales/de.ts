...
export const de: Partial<Record<TranslationKey, string>> = {
  ...
  "review.senderSubject": "Absender / Betreff",
  "review.proposedCategory": "Vorgeschlagene Kategorie",
  "review.reasonForReview": "Grund für die Prüfung",
  "review.time": "Zeit",
  "review.confirmClassification": "Klassifizierung bestätigen",
  "review.loadingFolders": "Ordner werden geladen…",
  "review.folderLoadFailed": "Postfachordner konnten nicht geladen werden.",
  "review.type.security": "Sicherheitsprüfung",
  "review.type.urgent": "Dringend",
  "review.type.action_required": "Aktion erforderlich",
  "review.type.action_failure": "Postfachaktion fehlgeschlagen",
  "review.type.routing_review": "Routing-Prüfung",
  "review.type.unresolved": "Mehr Kontext erforderlich",
  "review.type.classification_review": "Klassifizierungsprüfung",
  "review.type.attention": "Aufmerksamkeit erforderlich",
