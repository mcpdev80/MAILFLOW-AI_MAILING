export const enAccount = {
  ...
  "account.actions.automatic": "Automatic when safe",
  "account.actions.review": "Always review first",
  "account.actions.off": "Off",
  "account.actions.save": "Save action policy",
  "account.actions.saving": "Saving…",
  "account.actions.saved": "Mailbox action policy updated.",
  "account.actions.failed": "Could not update action policy.",
} as const;
