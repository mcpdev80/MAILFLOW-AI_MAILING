...
export const es: Partial<Record<TranslationKey, string>> = {
  ...
  "review.senderSubject": "Remitente / asunto",
  "review.proposedCategory": "Categoría propuesta",
  "review.reasonForReview": "Motivo de la revisión",
  "review.time": "Hora",
  "review.confirmClassification": "Confirmar clasificación",
  "review.loadingFolders": "Cargando carpetas…",
  "review.folderLoadFailed": "No se pudieron cargar las carpetas del buzón.",
  "review.type.security": "Revisión de seguridad",
  "review.type.urgent": "Urgente",
  "review.type.action_required": "Acción requerida",
  "review.type.action_failure": "Falló la acción del buzón",
  "review.type.routing_review": "Revisión de enrutamiento",
  "review.type.unresolved": "Se necesita más contexto",
  "review.type.classification_review": "Revisión de clasificación",
  "review.type.attention": "Requiere atención",
