...
def upgrade() -> None:
    op.create_table(
        ...
        sa.UniqueConstraint("org_id", "owner_scope", "parent_id", "name", name="uq_attachment_folder_sibling_name"),
    )
    op.create_index("ix_attachment_folders_owner", "attachment_folders", ["org_id", "owner_scope"])
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["folder_id"], ["attachment_folders.id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(["org_id"], ["organizations.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("document_id", "owner_scope", name="uq_attachment_placement_owner"),
    )
    op.create_index("ix_attachment_placements_owner", "attachment_placements", ["org_id", "owner_scope"])
    op.create_index("ix_attachment_placements_folder", "attachment_placements", ["folder_id"])
    ...
    op.create_index("ix_attachment_memory_owner", "attachment_memory", ["org_id", "owner_scope", "active"])
