...
class NotificationPreference(Base):
    ...
    security_review_enabled: Mapped[bool] = mapped_column(
        Boolean, default=True, server_default="true"
    )
    jobs_enabled: Mapped[bool] = mapped_column(
        Boolean, default=True, server_default="true"
    )
    mailbox_health_enabled: Mapped[bool] = mapped_column(
        Boolean, default=True, server_default="true"
    )
...
class NotificationEvent(Base):
    ...
    __table_args__ = (
        ...
        Index(
            "ix_notification_event_actor_created", "org_id", "user_key", "created_at"
        ),
    )
