...
class ProcessedEmail(Base):
    ...
    action_required: Mapped[str] = mapped_column(String(16), default="unknown", server_default="unknown")
    ...
    suspicious_content: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false")
    ...
    decision_memory_match_confidence: Mapped[float | None] = mapped_column(Float, nullable=True)
    decision_memory_hint_used: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false")

    auth_spf: Mapped[str] = mapped_column(String(16), default="unknown", server_default="unknown")
    auth_dkim: Mapped[str] = mapped_column(String(16), default="unknown", server_default="unknown")
    auth_dmarc: Mapped[str] = mapped_column(String(20), default="unknown", server_default="unknown")
    auth_arc: Mapped[str] = mapped_column(String(16), default="unknown", server_default="unknown")
    spam_verdict: Mapped[str] = mapped_column(String(16), default="unknown", server_default="unknown")
